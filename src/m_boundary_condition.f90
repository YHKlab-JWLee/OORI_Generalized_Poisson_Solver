MODULE m_boundary_condition
  ...
  PUBLIC :: build_periodic_halo, uses_periodic_stencil
...
!======================================================================================
  LOGICAL FUNCTION uses_periodic_stencil(bc_type)
!======================================================================================
    INTEGER, INTENT(IN) :: bc_type
    uses_periodic_stencil = (bc_type == BC_PERIODIC)
  END FUNCTION uses_periodic_stencil
