...
!    USE m_laplacian, ONLY: laplacian_fd
    ...
    USE m_boundary_condition, ONLY: BC_PERIODIC, uses_periodic_stencil
    IMPLICIT NONE
    logical   :: mg
    INTEGER                  :: N1, N2, N3
...
!--------------------------------------------------------------------------------------
    ...
    pi = 4.0_dp*atan(1.0_dp)
    pi8 = pi*8.0_dp
    pbc_stencil = uses_periodic_stencil(bc_type)

    IF (.NOT. pbc_stencil) THEN
      STOP 'cg_poisson_solver: Only periodic BC is supported in current test mode.'
    END IF
    ...
    call gradient_fd(pbc_stencil,CELL, N1, N2, N3, nfd, vhar,del1f, del2f, del3f) 
    ...
    call gradient_fd(pbc_stencil, CELL, N1, N2, N3, nfd, del1f, ddel1fx, ddel1fy, ddel1fz) 
    call gradient_fd(pbc_stencil, CELL, N1, N2, N3, nfd, del2f, ddel2fx, ddel2fy, ddel2fz) 
    call gradient_fd(pbc_stencil, CELL, N1, N2, N3, nfd, del3f, ddel3fx, ddel3fy, ddel3fz) 
    ...
    DO
      ...
      !  CALL filbdzero(N1,N2,N3,p)
       ...
       call gradient_fd(pbc_stencil, CELL, N1, N2, N3, nfd, p,del1f, del2f, del3f) 
